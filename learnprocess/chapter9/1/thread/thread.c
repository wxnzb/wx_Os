...
//所以可以说明pcb不是连续分配的，而且他的大小为4kb,这么大的吗？？？？
//不是哦，在2的thread.c中解答了，你也可以在想想
...
//为什么设置这个值？？？？？？？？？？？？？？？？？
//因为栈溢出时，栈会覆盖到这个魔数，如果魔数发生改变，说明栈已经溢出OK！！！原来如此，他的值是啥不重要，重要的是看他有没有被覆盖
...
{
//自己前在momory.c写的get_kernel_pages()派上用场了
